...
**封装**：封装类的变量和方法。1. 结合性，即是将属性和方法结合    2. 信息隐蔽性，利用接口机制，隐藏内部的细节和实现，只留下接口给外界调用    3. 实现代码重用

**继承**：在已有父类的基础上构造子类，子类继承父类的属性和方法，可以增加新的属性和方法
...
多态：是使一个接口，可以实现多种方法，即用的是同一个接口，但是效果各不相同，多态有两种形式的多态，一种是静态多态，一种是动态多态
...
来自 [https://www.scaler.com/topics/cpp-char/](https://www.scaler.com/topics/cpp-char/)
